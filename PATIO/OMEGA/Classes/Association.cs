...
{
    class Association: Classe_Modele, IComparable<Association>
    {
        public int TypeAssociation { get; set; }
        ...
        public override bool Construire(Element e)
        {
            ...
            TypeAssociation = e.Type_Element;
            Actif = e.Actif;
        ...
        public override Element Déconstruire()
        {
            ...
            e.Code = Code;
            e.Libelle = Libelle;
            e.Type_Element = TypeAssociation;
            e.Actif = Actif;
        ...
        public int CompareTo(Association p)
        {
