...
namespace PATIO.CAPA.Interfaces
{
    public partial class ctrlCorrectif : UserControl
    {
        ...
        void CorrigeLibelle()
        {
            ...
            List<PATIO.CAPA.Classes.Action> ListeAction = (List<PATIO.CAPA.Classes.Action>)Acces.Remplir_ListeElement(Acces.type_ACTION.id, "");
        ...
        void CorrigeCode_Action()
        {
            ...
            List<PATIO.CAPA.Classes.Action> Liste = (List<PATIO.CAPA.Classes.Action>)Acces.Remplir_ListeElement(Acces.type_ACTION.id, "");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PATIO.CAPA.Classes.Action action = (PATIO.CAPA.Classes.Action) Acces.Trouver_Element(Acces.type_ACTION.id, n);
