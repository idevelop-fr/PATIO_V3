...
namespace PATIO.MAIN.Classes
{
    class EditionFiche
    {
        ...
        public string Editer_Fiche_Action()
        {
            ...
            PATIO.CAPA.Classes.Action action = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION, id_element);

            PATIO.CAPA.Classes.Action parent = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION, id_parent);
