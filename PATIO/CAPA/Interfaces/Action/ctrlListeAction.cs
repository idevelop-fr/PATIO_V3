...
namespace PATIO.CAPA.Interfaces
{
    public partial class ctrlListeAction : UserControl
    {
        ...
        public void Trouver_Selection()
        {
            ...
            {
                if (n.Checked) { lAction.Add((PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION, int.Parse(n.Name))); }
                Explorer(n);
            }
        }
        ...
        private void lstAction_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            action = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION, id);
            CodeRef = action.Code;
        ...
        private void btnActionPhare_Click(object sender, EventArgs e)
        {
            Afficher_ListeAction();
        }
    }
