    ...
    class EditionFiche
    {
        ...
        public string Editer_Fiche_Plan()
        {
            ...
            foreach (Lien l in listeLien)
            {
                ...
                r = ws.Cells[n_ligne, 22];
                PATIO.CAPA.Classes.Action parent = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, l.element1_id);
        ...
        public string Editer_Fiche_Action()
        {
            ...
            PATIO.CAPA.Classes.Action action = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, id_element);

            PATIO.CAPA.Classes.Action parent = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, id_parent);
