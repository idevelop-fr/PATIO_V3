...
namespace PATIO.CAPA.Interfaces
{
    public partial class ctrlPlan : UserControl
    {
        ...
        void Ajouter_Lien()
        {
            ...
            {
                ElementParentCode = ((PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, ElementParentId)).Code;
        ...
        private void treeStructure_DragDrop(object sender, DragEventArgs e)
        {
            ...
            switch(element1_type_id)
            {
                ...
                case 3:
                    {
                        Code1 = ((PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, int.Parse(codeDest))).Code;
                        break;
                    }
                case 4:
                    {
            ...
            switch (element2_type_id)
            {
                ...
                case 3:
                    {
                        Code1 = ((PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, int.Parse(codeSrc))).Code;
                        break;
                    }
                case 4:
                    {
        ...
        void Ouvrir_Element()
        {
            ...
            if (typeElement == Acces.type_ACTION.code)
                    {
                        ctrllisteaction.action =(PATIO.CAPA.Classes.Action) Acces.Trouver_Element(Acces.type_ACTION.id, (int.Parse(idElement)));
                        ctrllisteaction.plan = plan;
        ...
        void Affecter_Droits_Action()
        {
            ...
            foreach (Lien l in listeLien)
            {
                if (l.element1_type == typeelement_id)
                {
                    PATIO.CAPA.Classes.Action action = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, l.element1_id);
        ...
        {
            PATIO.CAPA.Classes.Action action = (PATIO.CAPA.Classes.Action)Acces.Trouver_Element(Acces.type_ACTION.id, int.Parse(id));
