...
namespace PATIO.CAPA.Interfaces
{
    public partial class ctrlListeObjectif : UserControl
    {
        ...
        void Ajouter_SousObjectif()
        {
            ...
            Objectif obj = (Objectif)Acces.Trouver_Element(Acces.type_OBJECTIF, id);
            code = obj.Code;
            ...
            f.objectif.Actif = true;
            f.objectifParent = (Objectif)Acces.Trouver_Element(Acces.type_OBJECTIF, int.Parse(lstObjectif.SelectedNode.Name)); ;
        ...
        public void Modifier_Objectif()
        {
            ...
            Objectif P = (Objectif)Acces.Trouver_Element(Acces.type_OBJECTIF, Id);
        ...
        public void Trouver_Selection()
        {
            ...
            {
                if (n.Checked) { lObj.Add((Objectif)Acces.Trouver_Element(Acces.type_OBJECTIF, int.Parse(n.Name))); }
                Explorer(n);
            }
        }
        ...
        private void lstObjectif_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            obj = (Objectif)Acces.Trouver_Element(Acces.type_OBJECTIF, id);
        }
